...
const DetailTugas = React.lazy(() => import('./views/tugas/DetailTugas'))
const Keuangan = React.lazy(() => import('./views/keuangan/Keuangan'))
const Jadwal = React.lazy(() => import('./views/jadwal/Jadwal'))
const Anggota = React.lazy(() => import('./views/anggota/Anggota'))
...
const routes = [
  ...
  { path: '/kategori', name: 'Kategori', element: Kategori },
  { path: '/tugas', name: 'Tugas', element: Tugas },
  { path: '/detailtugas/:id', name: 'DetailTugas', element: DetailTugas },
